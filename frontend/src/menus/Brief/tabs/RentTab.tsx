namespace FlatApp{
    ...
    namespace Internal{
        export class RentTab extends React.Component<any,any>{
            constructor(props){
                super(props);
            }
            ...
            render(){
                return (
                    <Table multiSelectable={false} >
                        ...
                        <TableBody>
                        {
                            this.props.entityList.filter(i=>i.status=="inRental"||i.status=="rental").map((item, i) => {
    ...
    export const RentTab = ReactRedux.connect(mapStateToProps,mapDispatchToProps)(Internal.RentTab);
}